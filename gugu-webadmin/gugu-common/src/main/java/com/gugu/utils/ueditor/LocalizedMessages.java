package com.gugu.utils.ueditor;
...
import com.gugu.utils.springmvc.MessageResolver;
/**
...
public class LocalizedMessages {
	...
	public static String getInvalidUploadMultipartSpecified(HttpServletRequest request) {
		return getMessage(request,"fck.connector.invalid_multipart_specified"); //$NON-NLS-1$
	}
	
	public static String getInvalidUploadInputStreamSpecified(HttpServletRequest request) {
		return getMessage(request,"fck.connector.invalid_inputstream_specified"); //$NON-NLS-1$
	}
	
	public static String getRemoteImageSuccessSpecified(HttpServletRequest request) {
		return getMessage(request,"fck.connector.getremoteimage_success"); //$NON-NLS-1$
	}
