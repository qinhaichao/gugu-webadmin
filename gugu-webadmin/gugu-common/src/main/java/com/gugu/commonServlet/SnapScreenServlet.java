...
import com.gugu.utils.CmsConstants;
import com.gugu.utils.ResponseUtils;
import com.gugu.utils.springmvc.RealPathResolver;
import com.gugu.utils.ueditor.LocalizedMessages;
import com.gugu.utils.upload.UploadUtils;
...
public class SnapScreenServlet extends HttpServlet {
	...
	private String getSnapImageName(HttpServletRequest request,String ext){
		String filename = UploadUtils.generateFilename(CmsConstants.SNAP_PATH, ext);
		return filename;
	}
